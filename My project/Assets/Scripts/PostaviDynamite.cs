...
public class PostaviDynamite : MonoBehaviour
{
    [Header("Igrač")]
    public Transform igrac;

    [Header("Dynamite zamka")]
    public GameObject dynamiteUMikrovalnoj;
    ...
    private void Start()
    {
        ...
        if (dynamiteUMikrovalnoj != null)
        {
            dynamiteUMikrovalnoj.SetActive(false);
        }
    }
    ...
    private void OnMouseDown()
    {
        ...
        {
            Debug.LogWarning(
                "Igrač nije postavljen u PostaviDynamite skripti."
            );
        ...
        if (!inventory.JePredmetOdabran("Dynamite"))
        {
            Debug.Log(
                "U mikrovalnu moraš staviti Dynamite. " +
                "Odabrani predmet je: " +
                inventory.DohvatiOdabraniPredmet()
            );
        ...
        if (!inventory.ImaPredmet("Dynamite"))
        {
            Debug.Log(
                "Nemaš dynamite u inventoryju."
            );
        ...
        postavljanjeCoroutine = StartCoroutine(
            PostaviDynamiteNakonAnimacije(inventory)
        );
    }
    ...
    private IEnumerator PostaviDynamiteNakonAnimacije(
        InventoryIgraca inventory)
    {
        postavljaSe = true;
        ...
        if (dynamiteUMikrovalnoj != null)
        {
            dynamiteUMikrovalnoj.SetActive(true);
        }

        inventory.UkloniPredmet("Dynamite");
        ...
        Debug.Log(
            "Dynamite je postavljeno u mikrovalnu."
        );
    }
    ...
    private void PrekiniPostavljanje()
    {
        ...
        Debug.Log(
            "Postavljanje dynamita je prekinuto desnim klikom."
        );
    }
