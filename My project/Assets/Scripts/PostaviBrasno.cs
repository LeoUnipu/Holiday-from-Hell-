...
public class PostaviBrasno : MonoBehaviour
{
    [Header("Igrač")]
    public Transform igrac;

    [Header("Brasno zamka")]
    public GameObject brasnoNaMjestu;
    ...
    private void Start()
    {
        ...
        if (brasnoNaMjestu != null)
        {
            brasnoNaMjestu.SetActive(false);
        }
    }
    ...
    private void OnMouseDown()
    {
        ...
        {
            Debug.LogWarning(
                "Igrač nije postavljen u PostaviBrasno skripti."
            );
        ...
        if (!inventory.JePredmetOdabran("Brasno"))
        {
            Debug.Log(
                "U mikrovalnu moraš staviti Brasno. " +
                "Odabrani predmet je: " +
                inventory.DohvatiOdabraniPredmet()
            );
        ...
        if (!inventory.ImaPredmet("Brasno"))
        {
            Debug.Log(
                "Nemaš brasno u inventoryju."
            );
        ...
        postavljanjeCoroutine = StartCoroutine(
            PostaviBrasnoNakonAnimacije(inventory)
        );
    }
    ...
    private IEnumerator PostaviBrasnoNakonAnimacije(
        InventoryIgraca inventory)
    {
        postavljaSe = true;
        ...
        if (brasnoNaMjestu != null)
        {
            brasnoNaMjestu.SetActive(true);
        }

        inventory.UkloniPredmet("Brasno");
        ...
        Debug.Log(
            "Brasno je postavljeno u mikrovalnu."
        );
    }
    ...
    private void PrekiniPostavljanje()
    {
        ...
        Debug.Log(
            "Postavljanje brasna je prekinuto desnim klikom."
        );
    }
