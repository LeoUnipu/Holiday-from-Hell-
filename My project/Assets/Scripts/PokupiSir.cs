...
public class PokupiSir : MonoBehaviour
{
    [Header("Igrač")]
    ...
    private bool sirJePokupljen = false;
    ...
    private void Start()
    {
        ...
        {
            Debug.LogWarning(
                "Igrač nije postavljen u PokupiSir skripti."
            );
    ...
    private void OnMouseDown()
    {
        ...
        radnjaCoroutine = StartCoroutine(
            PokupiSirNakonAnimacije()
        );
    }

    private IEnumerator PokupiSirNakonAnimacije()
    {
        radnjaUTijeku = true;
        ...
        {
            Debug.Log(
                "Skupljanje sira je prekinuto. Sir nije pokupljeno."
            );
        ...
        inventory.DodajPredmet("Sir");

        PustiZvukSkupljanja();

        if (modelSira != null)
        {
            modelSira.SetActive(false);
        }
        else
        {
            Debug.LogWarning(
                "Model Sira nije spojen u Inspectoru."
            );
        }
    ...
    private void PrekiniTrenutnuRadnju()
    {
        ...
        {
            Debug.Log(
                "Pretraga sira je prekinuta desnim klikom."
            );
        }
        else
        {
            Debug.Log(
                "Skupljanje sira je prekinuto desnim klikom."
            );
        }
    }
    ...
    private void OkreniIgracaPremaSiru()
    {
        if (kretanjeIgraca == null ||
