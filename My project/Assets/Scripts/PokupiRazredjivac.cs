...
public class PokupiRazredjivac : MonoBehaviour
{
    [Header("Igrač")]
    ...
    public GameObject modelRazredjivaca;
    ...
    private bool razredjivacJePokupljen = false;
    ...
    private void Start()
    {
        ...
        {
            Debug.LogWarning(
                "Igrač nije postavljen u PokupiRazredjivac skripti."
            );
    ...
    private void OnMouseDown()
    {
        ...
        {
            Debug.Log(
                "Igrač je predaleko od razredjivaca."
            );
        ...
        radnjaCoroutine = StartCoroutine(
            PokupiRazredjivacNakonAnimacije()
        );
    }

    private IEnumerator PokupiRazredjivacNakonAnimacije()
    {
        radnjaUTijeku = true;
        ...
        {
            Debug.Log(
                "Skupljanje razredjivaca je prekinuto. Razredjivac nije pokupljeno."
            );
        ...
        inventory.DodajPredmet("Razredjivac");

        PustiZvukSkupljanja();

        if (modelRazredjivaca != null)
        {
            modelRazredjivaca.SetActive(false);
        }
        else
        {
            Debug.LogWarning(
                "Model Razredjivaca nije spojen u Inspectoru."
            );
        }

        razredjivacJePokupljen = true;

        ZavrsiRadnju();

        Debug.Log(
            "Igrač je pokupio razredjivac."
        );
    }
    ...
    private void PrekiniTrenutnuRadnju()
    {
        ...
        {
            Debug.Log(
                "Pretraga razredjivaca je prekinuta desnim klikom."
            );
        }
        else
        {
            Debug.Log(
                "Skupljanje razredjivaca je prekinuto desnim klikom."
            );
        }
    }
    ...
    private void OkreniIgracaPremaRazredjivacu()
    {
        if (kretanjeIgraca == null ||
