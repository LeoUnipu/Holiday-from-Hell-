...
{      
    ...
    public GameObject ikonaKanteRozeBoje;      
    public GameObject ikonaKljesta;      
    ...
    public void OdaberiKantuRozeBoje()      
    {      
        OdaberiPredmet("KantaRozeBoje");      
    }      

    public void OdaberiKljesta()      
    {      
        OdaberiPredmet("Kljesta");      
    }      
    ...
    {      
        ...
        if (ikonaKanteRozeBoje != null)      
        {      
            ikonaKanteRozeBoje.SetActive(ImaPredmet("KantaRozeBoje"));      
        }      

        if (ikonaKljesta != null)      
        {      
            ikonaKljesta.SetActive(ImaPredmet("Kljesta"));      
        }      
    }      
}