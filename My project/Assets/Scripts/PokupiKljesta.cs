...
public class PokupiKljesta : MonoBehaviour
{
    [Header("Igrač")]
    ...
    public GameObject modelKljesta;
    ...
    private bool kljestaSuPokupljena = false;
    ...
    private void Start()
    {
        ...
        {
            Debug.LogWarning(
                "Igrač nije postavljen u PokupiKljesta skripti."
            );
    ...
    private void OnMouseDown()
    {
        ...
        radnjaCoroutine = StartCoroutine(
            PokupiKljestaNakonAnimacije()
        );
    }

    private IEnumerator PokupiKljestaNakonAnimacije()
    {
        radnjaUTijeku = true;
        ...
        {
            Debug.Log(
                "Skupljanje kljesta je prekinuto. Kljesta nije pokupljeno."
            );
        ...
        inventory.DodajPredmet("Kljesta");

        PustiZvukSkupljanja();

        if (modelKljesta != null)
        {
            modelKljesta.SetActive(false);
        }
        else
        {
            Debug.LogWarning(
                "Model Kljesta nije spojen u Inspectoru."
            );
        }

        kljestaSuPokupljena = true;

        ZavrsiRadnju();

        Debug.Log(
            "Igrač je pokupio kljesta."
        );
    }
    ...
    private void PrekiniTrenutnuRadnju()
    {
        ...
        {
            Debug.Log(
                "Pretraga kljesta je prekinuta desnim klikom."
            );
        }
        else
        {
            Debug.Log(
                "Skupljanje kljesta je prekinuto desnim klikom."
            );
        }
    }
    ...
    private void OkreniIgracaPremaKljestima()
    {
        if (kretanjeIgraca == null ||
