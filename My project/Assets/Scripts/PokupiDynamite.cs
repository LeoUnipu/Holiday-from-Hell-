...
public class PokupiDynamite : MonoBehaviour
{
    [Header("Igrač")]
    ...
    public GameObject modelDynamita;
    ...
    private bool dynamiteJePokupljen = false;
    ...
    private void Start()
    {
        ...
        {
            Debug.LogWarning(
                "Igrač nije postavljen u PokupiDynamite skripti."
            );
    ...
    private void OnMouseDown()
    {
        ...
        {
            Debug.Log(
                "Igrač je predaleko od dynamita."
            );
        ...
        radnjaCoroutine = StartCoroutine(
            PokupiDynamiteNakonAnimacije()
        );
    }

    private IEnumerator PokupiDynamiteNakonAnimacije()
    {
        radnjaUTijeku = true;
        ...
        {
            Debug.Log(
                "Skupljanje dynamita je prekinuto. Dynamite nije pokupljeno."
            );
        ...
        inventory.DodajPredmet("Dynamite");

        PustiZvukSkupljanja();

        if (modelDynamita != null)
        {
            modelDynamita.SetActive(false);
        }
        else
        {
            Debug.LogWarning(
                "Model Dynamita nije spojen u Inspectoru."
            );
        }

        dynamiteJePokupljen = true;

        ZavrsiRadnju();

        Debug.Log(
            "Igrač je pokupio dynamite."
        );
    }
    ...
    private void PrekiniTrenutnuRadnju()
    {
        ...
        {
            Debug.Log(
                "Pretraga dynamita je prekinuta desnim klikom."
            );
        }
        else
        {
            Debug.Log(
                "Skupljanje dynamita je prekinuto desnim klikom."
            );
        }
    }
    ...
    private void OkreniIgracaPremaDynamitu()
    {
        if (kretanjeIgraca == null ||
