...
public class PostaviPin : MonoBehaviour
{
    [Header("Igrač")]
    public Transform igrac;

    [Header("Pin zamka")]
    public GameObject pinNaMjestu;
    ...
    private void OnMouseDown()
    {
        ...
        {
            Debug.LogWarning(
                "Igrač nije postavljen u PostaviPin skripti."
            );
        ...
        if (!inventory.JePredmetOdabran("Pin"))
        {
            Debug.Log(
                "U mikrovalnu moraš staviti Pin. " +
                "Odabrani predmet je: " +
                inventory.DohvatiOdabraniPredmet()
            );
        ...
        if (!inventory.ImaPredmet("Pin"))
        {
            Debug.Log(
                "Nemaš pin u inventoryju."
            );
        ...
        postavljanjeCoroutine = StartCoroutine(
            PostaviPinNakonAnimacije(inventory)
        );
    }
    ...
    private IEnumerator PostaviPinNakonAnimacije(
        InventoryIgraca inventory)
    {
        postavljaSe = true;
        ...
        if (pinNaMjestu != null)
        {
            pinNaMjestu.SetActive(true);
        }

        inventory.UkloniPredmet("Pin");
        ...
        Debug.Log(
            "Pin je postavljeno u mikrovalnu."
        );
    }
    ...
    private void PrekiniPostavljanje()
    {
        ...
        Debug.Log(
            "Postavljanje pina je prekinuto desnim klikom."
        );
    }
