...
public class PostaviWrench : MonoBehaviour
{
    [Header("Igrač")]
    public Transform igrac;

    [Header("Wrench zamka")]
    public GameObject wrenchNaMjestu;
    ...
    private void Start()
    {
        ...
        if (wrenchNaMjestu != null)
        {
            wrenchNaMjestu.SetActive(false);
        }
    }
    ...
    private void OnMouseDown()
    {
        ...
        {
            Debug.LogWarning(
                "Igrač nije postavljen u PostaviWrench skripti."
            );
        ...
        if (!inventory.JePredmetOdabran("Wrench"))
        {
            Debug.Log(
                "U mikrovalnu moraš staviti Wrench. " +
                "Odabrani predmet je: " +
                inventory.DohvatiOdabraniPredmet()
            );
        ...
        if (!inventory.ImaPredmet("Wrench"))
        {
            Debug.Log(
                "Nemaš wrench u inventoryju."
            );
        ...
        postavljanjeCoroutine = StartCoroutine(
            PostaviWrenchNakonAnimacije(inventory)
        );
    }
    ...
    private IEnumerator PostaviWrenchNakonAnimacije(
        InventoryIgraca inventory)
    {
        postavljaSe = true;
        ...
        if (wrenchNaMjestu != null)
        {
            wrenchNaMjestu.SetActive(true);
        }

        inventory.UkloniPredmet("Wrench");
        ...
        Debug.Log(
            "Wrench je postavljeno u mikrovalnu."
        );
    }
    ...
    private void PrekiniPostavljanje()
    {
        ...
        Debug.Log(
            "Postavljanje wrencha je prekinuto desnim klikom."
        );
    }
