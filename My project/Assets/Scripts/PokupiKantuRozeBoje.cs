...
public class PokupiKantuRozeBoje : MonoBehaviour
{
    [Header("Igrač")]
    ...
    public GameObject modelKanteRozeBoje;
    ...
    private bool kantaRozeBojeJePokupljena = false;
    ...
    private void Start()
    {
        ...
        {
            Debug.LogWarning(
                "Igrač nije postavljen u PokupiKantuRozeBoje skripti."
            );
    ...
    private void OnMouseDown()
    {
        ...
        {
            Debug.Log(
                "Igrač je predaleko od kante roze boje."
            );
        ...
        radnjaCoroutine = StartCoroutine(
            PokupiKantuRozeBojeNakonAnimacije()
        );
    }

    private IEnumerator PokupiKantuRozeBojeNakonAnimacije()
    {
        radnjaUTijeku = true;
        ...
        ZakljucajKretanje();
        OkreniIgracaPremaKantiRozeBoje();
        ...
        {
            Debug.Log(
                "Skupljanje kante roze boje je prekinuto. Kantu Roze Boje nije pokupljeno."
            );
        ...
        inventory.DodajPredmet("KantaRozeBoje");

        PustiZvukSkupljanja();

        if (modelKanteRozeBoje != null)
        {
            modelKanteRozeBoje.SetActive(false);
        }
        else
        {
            Debug.LogWarning(
                "Model Kante Roze Boje nije spojen u Inspectoru."
            );
        }

        kantaRozeBojeJePokupljena = true;

        ZavrsiRadnju();

        Debug.Log(
            "Igrač je pokupio kantu roze boje."
        );
    }
    ...
    private IEnumerator PokreniPraznuPretragu()
    {
        ...
        Debug.Log(
            "Ovdje više nema kante roze boje."
        );
    }
    ...
    private void PrekiniTrenutnuRadnju()
    {
        ...
        {
            Debug.Log(
                "Pretraga kante roze boje je prekinuta desnim klikom."
            );
        }
        else
        {
            Debug.Log(
                "Skupljanje kante roze boje je prekinuto desnim klikom."
            );
        }
    }
    ...
    private void OkreniIgracaPremaKantiRozeBoje()
    {
        if (kretanjeIgraca == null ||
