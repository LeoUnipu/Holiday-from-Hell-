...
public class PokupiWrench : MonoBehaviour
{
    [Header("Igrač")]
    ...
    public GameObject modelWrencha;
    ...
    private bool wrenchJePokupljen = false;
    ...
    private void Start()
    {
        ...
        {
            Debug.LogWarning(
                "Igrač nije postavljen u PokupiWrench skripti."
            );
    ...
    private void OnMouseDown()
    {
        ...
        radnjaCoroutine = StartCoroutine(
            PokupiWrenchNakonAnimacije()
        );
    }

    private IEnumerator PokupiWrenchNakonAnimacije()
    {
        radnjaUTijeku = true;
        ...
        {
            Debug.Log(
                "Skupljanje wrencha je prekinuto. Wrench nije pokupljeno."
            );
        ...
        inventory.DodajPredmet("Wrench");

        PustiZvukSkupljanja();

        if (modelWrencha != null)
        {
            modelWrencha.SetActive(false);
        }
        else
        {
            Debug.LogWarning(
                "Model Wrencha nije spojen u Inspectoru."
            );
        }

        wrenchJePokupljen = true;

        ZavrsiRadnju();

        Debug.Log(
            "Igrač je pokupio wrench."
        );
    }
    ...
    private void PrekiniTrenutnuRadnju()
    {
        ...
        {
            Debug.Log(
                "Pretraga wrencha je prekinuta desnim klikom."
            );
        }
        else
        {
            Debug.Log(
                "Skupljanje wrencha je prekinuto desnim klikom."
            );
        }
    }
    ...
    private void OkreniIgracaPremaWrenchu()
    {
        if (kretanjeIgraca == null ||
