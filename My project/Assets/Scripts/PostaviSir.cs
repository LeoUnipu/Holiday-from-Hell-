...
public class PostaviSir : MonoBehaviour
{
    [Header("Igrač")]
    public Transform igrac;

    [Header("Sir zamka")]
    public GameObject sirNaMjestu;
    ...
    private void OnMouseDown()
    {
        ...
        {
            Debug.LogWarning(
                "Igrač nije postavljen u PostaviSir skripti."
            );
        ...
        if (!inventory.JePredmetOdabran("Sir"))
        {
            Debug.Log(
                "U mikrovalnu moraš staviti Sir. " +
                "Odabrani predmet je: " +
                inventory.DohvatiOdabraniPredmet()
            );
        ...
        if (!inventory.ImaPredmet("Sir"))
        {
            Debug.Log(
                "Nemaš sir u inventoryju."
            );
        ...
        postavljanjeCoroutine = StartCoroutine(
            PostaviSirNakonAnimacije(inventory)
        );
    }
    ...
    private IEnumerator PostaviSirNakonAnimacije(
        InventoryIgraca inventory)
    {
        postavljaSe = true;
        ...
        if (sirNaMjestu != null)
        {
            sirNaMjestu.SetActive(true);
        }

        inventory.UkloniPredmet("Sir");
        ...
        Debug.Log(
            "Sir je postavljeno u mikrovalnu."
        );
    }
    ...
    private void PrekiniPostavljanje()
    {
        ...
        Debug.Log(
            "Postavljanje sira je prekinuto desnim klikom."
        );
    }
