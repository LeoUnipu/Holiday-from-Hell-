...
public class PokupiLjutiUmak : MonoBehaviour
{
    [Header("Igrač")]
    ...
    public GameObject modelLjutogUmaka;
    ...
    private bool ljutiUmakJePokupljen = false;
    ...
    private void Start()
    {
        ...
        {
            Debug.LogWarning(
                "Igrač nije postavljen u PokupiLjutiUmak skripti."
            );
    ...
    private void OnMouseDown()
    {
        ...
        {
            Debug.Log(
                "Igrač je predaleko od ljutog umaka."
            );
        ...
        radnjaCoroutine = StartCoroutine(
            PokupiLjutiUmakNakonAnimacije()
        );
    }

    private IEnumerator PokupiLjutiUmakNakonAnimacije()
    {
        radnjaUTijeku = true;
        ...
        {
            Debug.Log(
                "Skupljanje ljutog umaka je prekinuto. Umak nije pokupljen."
            );
        ...
        inventory.DodajPredmet("LjutiUmak");

        PustiZvukSkupljanja();

        if (modelLjutogUmaka != null)
        {
            modelLjutogUmaka.SetActive(false);
        }
        else
        {
            Debug.LogWarning(
                "Model Ljutog Umaka nije spojen u Inspectoru."
            );
        }

        ljutiUmakJePokupljen = true;

        ZavrsiRadnju();

        Debug.Log(
            "Igrač je pokupio ljuti umak."
        );
    }
    ...
    private void PrekiniTrenutnuRadnju()
    {
        ...
        {
            Debug.Log(
                "Pretraga ljutog umaka je prekinuta desnim klikom."
            );
        }
        else
        {
            Debug.Log(
                "Skupljanje ljutog umaka je prekinuto desnim klikom."
            );
        }
    }
    ...
    private void OkreniIgracaPremaUmaku()
    {
        if (kretanjeIgraca == null ||
