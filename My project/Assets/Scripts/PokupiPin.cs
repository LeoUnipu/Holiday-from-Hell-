...
public class PokupiPin : MonoBehaviour
{
    [Header("Igrač")]
    ...
    private bool pinJePokupljen = false;
    ...
    private void Start()
    {
        ...
        {
            Debug.LogWarning(
                "Igrač nije postavljen u PokupiPin skripti."
            );
    ...
    private void OnMouseDown()
    {
        ...
        radnjaCoroutine = StartCoroutine(
            PokupiPinNakonAnimacije()
        );
    }

    private IEnumerator PokupiPinNakonAnimacije()
    {
        radnjaUTijeku = true;
        ...
        {
            Debug.Log(
                "Skupljanje pina je prekinuto. Pin nije pokupljeno."
            );
        ...
        inventory.DodajPredmet("Pin");

        PustiZvukSkupljanja();

        if (modelPina != null)
        {
            modelPina.SetActive(false);
        }
        else
        {
            Debug.LogWarning(
                "Model Pina nije spojen u Inspectoru."
            );
        }
    ...
    private void PrekiniTrenutnuRadnju()
    {
        ...
        {
            Debug.Log(
                "Pretraga pina je prekinuta desnim klikom."
            );
        }
        else
        {
            Debug.Log(
                "Skupljanje pina je prekinuto desnim klikom."
            );
        }
    }
    ...
    private void OkreniIgracaPremaPinu()
    {
        if (kretanjeIgraca == null ||
