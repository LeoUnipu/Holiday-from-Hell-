...
public class PostaviLjutiUmakUPivo : MonoBehaviour
{
    [Header("Igrač")]
    public Transform igrac;

    [Header("Podvala s pivom")]
    public GameObject ljutoPivo;
    ...
    private void OnMouseDown()
    {
        ...
        {
            Debug.LogWarning(
                "Igrač nije postavljen u PostaviLjutiUmakUPivo skripti."
            );
        ...
        if (!inventory.JePredmetOdabran("LjutiUmak"))
        {
            Debug.Log(
                "U pivo moraš staviti LjutiUmak. " +
                "Odabrani predmet je: " +
                inventory.DohvatiOdabraniPredmet()
            );
        ...
        if (!inventory.ImaPredmet("LjutiUmak"))
        {
            Debug.Log(
                "Nemaš ljuti umak u inventoryju."
            );
        ...
        postavljanjeCoroutine = StartCoroutine(
            PostaviUmakNakonAnimacije(inventory)
        );
    }
    ...
    private IEnumerator PostaviUmakNakonAnimacije(
        InventoryIgraca inventory)
    {
        postavljaSe = true;
        ...
        if (ljutoPivo != null)
        {
            ljutoPivo.SetActive(true);
        }

        inventory.UkloniPredmet("LjutiUmak");
    ...
    private void OkreniIgracaPremaPivu()
    {
        if (kretanjeIgraca == null ||
    ...
    private void PrekiniPostavljanje()
    {
        ...
        Debug.Log(
            "Postavljanje ljutog umaka je prekinuto desnim klikom."
        );
    }
