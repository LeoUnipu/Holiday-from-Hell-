...
public class PostaviKantuRozeBoje : MonoBehaviour
{
    [Header("Igrač")]
    public Transform igrac;

    [Header("KantaRozeBoje zamka")]
    public GameObject kantaRozeBojeNaMjestu;
    ...
    private void Start()
    {
        ...
        if (kantaRozeBojeNaMjestu != null)
        {
            kantaRozeBojeNaMjestu.SetActive(false);
        }
    }
    ...
    private void OnMouseDown()
    {
        ...
        {
            Debug.LogWarning(
                "Igrač nije postavljen u PostaviKantuRozeBoje skripti."
            );
        ...
        if (!inventory.JePredmetOdabran("KantaRozeBoje"))
        {
            Debug.Log(
                "U mikrovalnu moraš staviti KantaRozeBoje. " +
                "Odabrani predmet je: " +
                inventory.DohvatiOdabraniPredmet()
            );
        ...
        if (!inventory.ImaPredmet("KantaRozeBoje"))
        {
            Debug.Log(
                "Nemaš kanta roze boje u inventoryju."
            );
        ...
        postavljanjeCoroutine = StartCoroutine(
            PostaviKantuRozeBojeNakonAnimacije(inventory)
        );
    }
    ...
    private IEnumerator PostaviKantuRozeBojeNakonAnimacije(
        InventoryIgraca inventory)
    {
        postavljaSe = true;
        ...
        if (kantaRozeBojeNaMjestu != null)
        {
            kantaRozeBojeNaMjestu.SetActive(true);
        }

        inventory.UkloniPredmet("KantaRozeBoje");
        ...
        Debug.Log(
            "KantaRozeBoje je postavljeno u mikrovalnu."
        );
    }
    ...
    private void PrekiniPostavljanje()
    {
        ...
        Debug.Log(
            "Postavljanje kante roze boje je prekinuto desnim klikom."
        );
    }
