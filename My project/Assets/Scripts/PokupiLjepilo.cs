...
public class PokupiLjepilo : MonoBehaviour
{
    [Header("Igrač")]
    ...
    public GameObject modelLjepila;
    ...
    private bool ljepiloJePokupljeno = false;
    ...
    private void Start()
    {
        ...
        {
            Debug.LogWarning(
                "Igrač nije postavljen u PokupiLjepilo skripti."
            );
    ...
    private void OnMouseDown()
    {
        ...
        radnjaCoroutine = StartCoroutine(
            PokupiLjepiloNakonAnimacije()
        );
    }

    private IEnumerator PokupiLjepiloNakonAnimacije()
    {
        radnjaUTijeku = true;
        ...
        {
            Debug.Log(
                "Skupljanje ljepila je prekinuto. Ljepilo nije pokupljeno."
            );
        ...
        inventory.DodajPredmet("Ljepilo");

        PustiZvukSkupljanja();

        if (modelLjepila != null)
        {
            modelLjepila.SetActive(false);
        }
        else
        {
            Debug.LogWarning(
                "Model Ljepila nije spojen u Inspectoru."
            );
        }

        ljepiloJePokupljeno = true;

        ZavrsiRadnju();

        Debug.Log(
            "Igrač je pokupio ljepilo."
        );
    }
    ...
    private void PrekiniTrenutnuRadnju()
    {
        ...
        {
            Debug.Log(
                "Pretraga ljepila je prekinuta desnim klikom."
            );
        }
        else
        {
            Debug.Log(
                "Skupljanje ljepila je prekinuto desnim klikom."
            );
        }
    }
    ...
    private void OkreniIgracaPremaLjepilu()
    {
        if (kretanjeIgraca == null ||
