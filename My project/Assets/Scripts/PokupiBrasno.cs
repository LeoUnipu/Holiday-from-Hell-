...
public class PokupiBrasno : MonoBehaviour
{
    [Header("Igrač")]
    ...
    private bool brasnoJePokupljeno = false;
    ...
    private void Start()
    {
        ...
        {
            Debug.LogWarning(
                "Igrač nije postavljen u PokupiBrasno skripti."
            );
    ...
    private void OnMouseDown()
    {
        ...
        radnjaCoroutine = StartCoroutine(
            PokupiBrasnoNakonAnimacije()
        );
    }

    private IEnumerator PokupiBrasnoNakonAnimacije()
    {
        radnjaUTijeku = true;
        ...
        {
            Debug.Log(
                "Skupljanje brasna je prekinuto. Brasno nije pokupljeno."
            );
        ...
        inventory.DodajPredmet("Brasno");

        PustiZvukSkupljanja();

        if (modelBrasna != null)
        {
            modelBrasna.SetActive(false);
        }
        else
        {
            Debug.LogWarning(
                "Model Brasna nije spojen u Inspectoru."
            );
        }

        brasnoJePokupljeno = true;

        ZavrsiRadnju();

        Debug.Log(
            "Igrač je pokupio brasno."
        );
    }
    ...
    private void PrekiniTrenutnuRadnju()
    {
        ...
        {
            Debug.Log(
                "Pretraga brasna je prekinuta desnim klikom."
            );
        }
        else
        {
            Debug.Log(
                "Skupljanje brasna je prekinuto desnim klikom."
            );
        }
    }
    ...
    private void OkreniIgracaPremaBrasnu()
    {
        if (kretanjeIgraca == null ||
