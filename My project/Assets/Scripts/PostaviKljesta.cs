...
public class PostaviKljesta : MonoBehaviour
{
    [Header("Igrač")]
    public Transform igrac;

    [Header("Kljesta zamka")]
    public GameObject kljestaNaMjestu;
    ...
    private void Start()
    {
        ...
        if (kljestaNaMjestu != null)
        {
            kljestaNaMjestu.SetActive(false);
        }
    }
    ...
    private void OnMouseDown()
    {
        ...
        {
            Debug.LogWarning(
                "Igrač nije postavljen u PostaviKljesta skripti."
            );
        ...
        if (!inventory.JePredmetOdabran("Kljesta"))
        {
            Debug.Log(
                "U mikrovalnu moraš staviti Kljesta. " +
                "Odabrani predmet je: " +
                inventory.DohvatiOdabraniPredmet()
            );
        ...
        if (!inventory.ImaPredmet("Kljesta"))
        {
            Debug.Log(
                "Nemaš kljesta u inventoryju."
            );
        ...
        postavljanjeCoroutine = StartCoroutine(
            PostaviKljestaNakonAnimacije(inventory)
        );
    }
    ...
    private IEnumerator PostaviKljestaNakonAnimacije(
        InventoryIgraca inventory)
    {
        postavljaSe = true;
        ...
        if (kljestaNaMjestu != null)
        {
            kljestaNaMjestu.SetActive(true);
        }

        inventory.UkloniPredmet("Kljesta");
        ...
        Debug.Log(
            "Kljesta je postavljeno u mikrovalnu."
        );
    }
    ...
    private void PrekiniPostavljanje()
    {
        ...
        Debug.Log(
            "Postavljanje kljesta je prekinuto desnim klikom."
        );
    }
